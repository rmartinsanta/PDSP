...
public class PMPRv4 extends PMPR {

    private final int k = 5;

    private final int nSubconjuntos = 9;

    public PMPRv4(Reconstructive<PDSPSolution, PDSPInstance> repair, Improver<PDSPSolution, PDSPInstance> improver) {
        super(repair, improver);
    }

    public PMPRv4(CSharpGRGrasp constructive, RemoveNodesLS ls, double evaluationProbability) {
